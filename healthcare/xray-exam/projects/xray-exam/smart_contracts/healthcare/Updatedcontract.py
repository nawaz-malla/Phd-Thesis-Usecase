...
class healthcare(ARC4Contract):
    ...
    @subroutine
    def parallel_split(self) -> UInt64:
    ...
    # ========== TASKS (BASIC - same as Figure 1) ==========

    @abimethod
    def take_appointment(self, medical_prescription: String) -> None:
    ...
    @abimethod
    def check_availability(self, request_id: String) -> None:
    ...
    @abimethod
    def send_availability(self, accepted: UInt64, date: String) -> None:
    ...
    @abimethod
    def confirm_appointment(self, appointment_id: String) -> None:
        """Radiology sends registration to Patient - MODIFIED to trigger parallel"""
        assert self.locked.value == UInt64(0), "Contract is locked"
    ...
    # ========== NEW TASKS (Parallel gateway) ==========

    @abimethod
    def check_certification(self, certification_id: String) -> None:
        """Patient sends certification to Radiology"""
        assert self.locked.value == UInt64(0), "Contract is locked"
    ...
    @abimethod
    def check_temperature(self, temperature: String) -> None:
        """Patient sends temperature to Radiology"""
        assert self.locked.value == UInt64(0), "Contract is locked"
    ...
    # ========== TASKS (Continue after parallel join) ==========

    @abimethod
    def checkin(self, appointment_id: String) -> None:
        """Patient sends checkin to Radiology - MODIFIED to use e18"""
        assert self.locked.value == UInt64(0), "Contract is locked"
    ...
    @abimethod
    def checkin_confirmation(self, registration_confirmed: UInt64) -> None:
    ...
    @abimethod
    def xray_analysis(self, ticket_id: String, report: String) -> None:
    ...
    @abimethod
    def xray_report(self, result_id: String) -> None:
