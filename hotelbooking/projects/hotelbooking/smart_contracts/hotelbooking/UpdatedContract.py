# updated Version of HotelBooking contract with added refund process
from algopy import (
    Account,
    Bytes,
    GlobalState,
...
class HotelBooking(ARC4Contract):
    def __init__(self) -> None:
        ...
        self.e7 = GlobalState(UInt64(0))
        self.e8 = GlobalState(UInt64(0))
        self.e9 = GlobalState(UInt64(0))
        self.e10 = GlobalState(UInt64(0))
        self.e11 = GlobalState(UInt64(0))
        self.e12 = GlobalState(UInt64(0))
        self.e13 = GlobalState(UInt64(0))
        self.e14 = GlobalState(UInt64(0))  # Added new edge for updated Version
        ...
        self.refund_id = GlobalState(
            String("")
        )  # Added new data object for updated Version
    ...
    @subroutine
    def xor3_cancel(self) -> UInt64:
        """XOR gateway 3: cancel check"""
    ...
    @abimethod
    def ask_refund(self, refund_id: String) -> None:
        """Task 11: Client requests refund"""
        assert self.locked.value == UInt64(0), "Contract is locked"
    ...
    @abimethod
    def refund_request(self, address_payable: String) -> None:
        """Task 12: Hotel processes refund"""
        assert self.locked.value == UInt64(0), "Contract is locked"
